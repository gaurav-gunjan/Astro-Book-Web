            ...
            <section className='px-[80px] max-md:px-[20px] pb-5 max-md:pb-0'>
                <main className='flex justify-end'>
                    <div className='border border-[#DDDDDD] rounded-md flex items-center max-sm:w-[90vw]'>
                        <input type='search' placeholder='Let’s find what you’re looking for..' className='outline-none px-3 text-[16px] max-md:text-[16px] rounded-md h-full w-[330px] max-xl:w-[300px] max-lg:w-[100%]' />
