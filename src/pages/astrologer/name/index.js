                            ...
                            <div className='flex max-md:flex-col gap-[20px]'>
                                ...
                                <div className='flex flex-col justify-center gap-1.5 text-lg rounded-xl p-[15px]'>
                                    ...
                                    <div className='flex max-lg:flex-wrap gap-[20px]'>
                                        ...
                                        }} disabled={astrologerDataById?.call_status != "online"} className={`flex items-center gap-2 bg-primary text-black px-2 py-[7px] rounded-full w-[280px] ${astrologerDataById?.call_status != "online" && 'cursor-not-allowed'}`}><div className='bg-white p-2 rounded-full'><CallSvg h='25' w='25' color={Color?.black} /></div> <div className='line-clamp-1 text-center flex-1 pr-5'>Start Call</div></button>
                                        ...
                                        }} disabled={astrologerDataById?.chat_status != "online"} className={`flex items-center gap-2 bg-primary text-black px-2 py-[7px] rounded-full w-[280px] ${astrologerDataById?.chat_status != "online" && 'cursor-not-allowed'}`}><div className='bg-white p-2 rounded-full'><ChatSvg h='25' w='25' color={Color?.black} /></div> <div className='line-clamp-1 text-center flex-1 pr-5'>Start Chat</div></button>
                                    </div>
                                </div>
                            </div>
