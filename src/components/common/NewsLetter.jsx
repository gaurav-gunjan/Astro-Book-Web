    ...
    return (
        <>
            <section className='px-[46px] max-md:px-5 pt-20 -mb-[51px]'>
                <article>
                    <main className='relative bg-[#F1B646] rounded-[75.73px] max-md:rounded-3xl py-10 max-md:py-7 flex items-center justify-center max-lg:flex-col gap-20 max-lg:gap-7 max-md:gap-4'>
                        ...
                        <button className='bg-white rounded-[55px] px-9 py-4 max-lg:py-3 text-[25px] max-xl:text-[22px] max-lg:text-[20px] max-md:text-[16px] font-semibold'>Talk To Astrologer</button>
                    </main>
                </article>
            </section>
